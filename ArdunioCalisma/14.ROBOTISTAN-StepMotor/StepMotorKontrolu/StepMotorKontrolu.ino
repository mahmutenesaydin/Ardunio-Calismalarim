String agAdi = "TurkTelekom_ZVKEW";                   //Ağımızın adını buraya yazıyoruz.    
String agSifresi = "Yusuf0571";             //Ağımızın şifresini buraya yazıyoruz.
  ...
  if(Serial.available()){               //Seri haberleşme verisi geldiğinde içindeki komutlar çalışır.
    ...
    {                                   //Bağlantı isteği geldiğinde içindeki komutlar çalışır.
      ...
      {                    //İleri komutu geldiğinde içerisindeki komutlar çalışır.
        ...
        {                    //Step motora 20 kere ileri hareketi yaptırılır.
          stepIleri(20); 
        }
      }
      ...
      {                     //Geri komutu geldiğinde içerisindeki komutlar çalışır.
        for(int adim = 0; adim < 50; adim++)
        {                    //Step motora 20 kere geri hareketi yaptırılır.
          stepGeri(20); 
        }
      }
